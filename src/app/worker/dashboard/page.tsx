...
const jobPosts: JobPost[] = [
  ...
  { farmerName: 'Machine Mohan (மெஷின் மோகன்)', location: 'Annur, Coimbatore (அன்னூர், கோயம்புத்தூர்)', acres: 50, landDetails: 'Large scale maize farm (பெரிய அளவிலான மக்காச்சோள பண்ணை)', workerExpectations: 'Operate combine harvester for maize (மக்காச்சோளம் அறுவடை செய்ய கம்பைன் ஹார்வெஸ்டரை இயக்க வேண்டும்)', workHours: '10 Hours (10 மணி நேரம்)', salary: 1500, farmerEmail: 'machine.mohan@email.com', farmerPhone: '9876512345', farmerRating: 4.8, farmerImage: 'https://placehold.co/100x100.png?text=மெ', farmerImageHint: 'man on harvester' },
  ...
  // Tiruchirappalli
  { farmerName: 'Agri Machinaries Inc. (அக்ரி மெஷினரீஸ் இன்க்)', location: 'Manapparai, Tiruchirappalli (மணப்பாறை, திருச்சிராப்பள்ளி)', acres: 100, landDetails: 'Machinery Rental Services (இயந்திரங்கள் வாடகை சேவைகள்)', workerExpectations: 'Operate power tiller for various farmlands (பல்வேறு பண்ணைகளுக்கு பவர் டில்லர் இயக்குதல்)', workHours: '8 Hours (8 மணி நேரம்)', salary: 1200, farmerEmail: 'contact@agrimachinaries.com', farmerPhone: '9988776656', farmerRating: 4.9, farmerImage: 'https://placehold.co/100x100.png?text=அ', farmerImageHint: 'company logo' },
  ...
  // Salem
  { farmerName: 'Steel Plant Agri Division (ஸ்டீல் பிளாண்ட் அக்ரி டிவிஷன்)', location: 'Omalur, Salem (ஓமலூர், சேலம்)', acres: 75, landDetails: 'Multi-crop farm (பல்வகை பயிர் பண்ணை)', workerExpectations: 'Drive tractor for ploughing and transport (உழவு மற்றும் போக்குவரத்துக்கு டிராக்டர் ஓட்டுதல்)', workHours: '8 Hours (8 மணி நேரம்)', salary: 1000, farmerEmail: 'agri@salemsteel.com', farmerPhone: '9776655444', farmerRating: 4.5, farmerImage: 'https://placehold.co/100x100.png?text=S', farmerImageHint: 'industrial building' },
  ...
  { farmerName: 'Agri Drone Services (அக்ரி ட்ரோன் சர்வீசஸ்)', location: 'Palani, Dindigul (பழனி, திண்டுக்கல்)', acres: 200, landDetails: 'Hilly terrain farms (மலைப்பகுதி பண்ணைகள்)', workerExpectations: 'Operate drones for pesticide spraying (பூச்சிமருந்து தெளிக்க ட்ரோன் இயக்குதல்)', workHours: '6 Hours (6 மணி நேரம்)', salary: 2000, farmerEmail: 'contact@agridrones.com', farmerPhone: '9221100996', farmerRating: 5.0, farmerImage: 'https://placehold.co/100x100.png?text=ட்ரோ', farmerImageHint: 'drone flying' },
